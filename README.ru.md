...
Discord музыкальный бот с современным веб-интерфейсом на React для управления воспроизведением.

## ✨ Возможности

- 🎶 Воспроизведение музыки из YouTube, Spotify, SoundCloud, Яндекс.Музыка
- 📋 Поддержка плейлистов (YouTube, SoundCloud) и YouTube Mix/Radio
...
- Node.js 22.12+ (рекомендуется 24+)
- npm или yarn
- Discord Bot Token
...
Данный проект предназначен **только для образовательных целей и личного использования**.

- Разработчики не несут ответственности за неправомерное использование данного программного обеспечения
- Пользователи обязаны соблюдать Условия использования сторонних платформ (YouTube, Spotify, SoundCloud, Яндекс.Музыка и др.)
- Данное программное обеспечение не должно использоваться в коммерческих целях
- Соблюдайте законодательство об авторских правах в вашей юрисдикции
- Бот не хранит и не распространяет защищённый авторским правом контент
